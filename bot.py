...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "Assalomu alaykum! 👋\n\n"
        "Men *Xisobchi* — pullaringiz qayerga ketayotganini kuzatib boraman. "
        "Har bir so'mingiz hisobda! 💰\n\n"
        "✍️ Harajatni yozish juda oson, masalan:\n"
        "  • `non 3500`\n"
        "  • `taksi 15 ming`\n"
        "  • `tushlik 35000`\n"
        "  • `internet 200 ming`\n\n"
        "🧾 Bir nechta narsani *vergul* bilan yozing:\n"
        "  `non 3500, cola 5000, avtobus 1500`\n\n"
        "🏷 Kategoriyani men o'zim aniqlayman — siz faqat yozing!\n\n"
        "📊 Hisobot ko'rish uchun pastdagi tugmalardan foydalaning.\n\n"
        f"_Rejim: {mode}_"
    )
